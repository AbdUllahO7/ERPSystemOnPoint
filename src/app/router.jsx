...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "web-service/content", element: lazyLoad(() => import("../pages/dashboard/WebsiteBuilder/WebsiteContentEditorPage")) },
      { path: "web-service/content/:websiteId", element: lazyLoad(() => import("../pages/dashboard/WebsiteBuilder/WebsiteContentEditorPage")) },
      { path: "web-service/ecommerce-content", element: lazyLoad(() => import("../pages/dashboard/WebsiteBuilder/EcommerceContentEditorPage")) },
      { path: "web-service/ecommerce-content/:websiteId", element: lazyLoad(() => import("../pages/dashboard/WebsiteBuilder/EcommerceContentEditorPage")) },
      { path: "web-service/orders", element: lazyLoad(() => import("../pages/dashboard/WebsiteBuilder/EcommerceOrdersPage")) },
      { path: "web-service/orders/:orderId", element: lazyLoad(() => import("../pages/dashboard/WebsiteBuilder/EcommerceOrderDetailsPage")) },
