      ...
      <div className="xl:col-span-2 space-y-6">
        <div className="bg-card p-6 rounded-xl border shadow-sm grid grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Input placeholder="Original Invoice Number" className={`h-9 bg-transparent ${errors.original_invoice_number ? "border-red-500" : ""}`} {...register("original_invoice_number", { required: "Required" })} />
