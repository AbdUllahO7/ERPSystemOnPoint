    ...
    <div className="bg-white rounded-2xl border border-slate-200/80 p-3 sm:p-5 shadow-xs flex items-center justify-center gap-3">
      ...
      {hasNext ? (
        <button
          ...
          onClick={onNext}
          disabled={isSaving}
          className="w-full sm:w-36 py-3 px-6 rounded-xl bg-[#0066d1] hover:bg-[#0052a8] text-white font-bold text-sm shadow-md transition-all active:scale-95 disabled:opacity-50"
        >
          Next
        </button>
      ) : (
